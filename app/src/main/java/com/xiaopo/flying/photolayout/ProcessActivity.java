...
public class ProcessActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_replace) {
            showSelectedPhotoDialog();
        } else if (viewId == R.id.btn_rotate) {
            puzzleView.rotate(90f);
        } else if (viewId == R.id.btn_flip_horizontal) {
            puzzleView.flipHorizontally();
        } else if (viewId == R.id.btn_flip_vertical) {
            puzzleView.flipVertically();
        } else if (viewId == R.id.btn_border) {
        ...
        } else if (viewId == R.id.btn_corner) {
